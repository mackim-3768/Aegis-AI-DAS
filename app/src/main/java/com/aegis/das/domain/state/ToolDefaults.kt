...
object ToolDefaults {
    private val contextDefaults: Map<ToolId, Map<String, Any?>> = mapOf(
        ...
        ToolId.GET_PEDAL_MISAPPLICATION_RISK to mapOf("value" to false, "level" to "low", "confidence" to 0.0),
    ...
    private val actionDefaults: Map<ToolId, Map<String, Any?>> = mapOf(
        ...
        ToolId.LIMIT_ENGINE_TORQUE to mapOf("enabled" to false, "max_ratio" to 1.0, "duration_ms" to 0, "reason" to ""),
