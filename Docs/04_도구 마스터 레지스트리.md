        ...
        "warnings": {
          ...
          "items": {
            ...
            "properties": {
              ...
              "timestamp": { "type": "STRING", "description": "Event timestamp (ISO-8601 recommended)." }
            },
  ...
  "function": {
    ...
    "parameters": {
      ...
      "properties": {
        ...
        "time_to_change": { "type": "INTEGER", "description": "Seconds until the signal changes if available." },
  ...
  "function": {
    ...
    "parameters": {
      ...
      "properties": {
        ...
        "duration_ms": { "type": "INTEGER", "description": "Scent release duration in milliseconds." }
      },
      "required": ["enabled"]
    }
  }
  ...
  "function": {
    ...
    "parameters": {
      ...
      "properties": {
        ...
        "duration_ms": { "type": "INTEGER", "description": "How long the hazard signals should stay active." }
      },
      "required": ["enabled"]
    }
  }
  ...
  "function": {
    ...
    "parameters": {
      ...
      "properties": {
        ...
        "duration_ms": { "type": "INTEGER", "description": "Massage duration in milliseconds." }
      },
      "required": ["enabled"]
    }
  }
